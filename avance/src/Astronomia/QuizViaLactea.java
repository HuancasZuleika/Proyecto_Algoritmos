...
import Astronomia.QuizViaLactea1;
import Astronomia.ResponsiveResizer;
...
timerZoom.start();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jBtnCohete, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 490, 130, 360));
        ...
        jBtnAtras.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/btnatras (1).png"))); // NOI18N
        jBtnAtras.setBorderPainted(false);
        jBtnAtras.setContentAreaFilled(false);
        jBtnAtras.addActionListener(this::jBtnAtrasActionPerformed);
        getContentPane().add(jBtnAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 550, 100, 110));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 700, -1, -1));
  ...
  // cierra esta ventana actual (opcional)
