 ...
 * @author User
 */
public class teoriaEstEst1 extends javax.swing.JFrame {
    
    private AstronautaController astro;
    private AudioController audio;
    
    public teoriaEstEst1() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teoriaEstEst1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new teoriaEstEst1().setVisible(true);
