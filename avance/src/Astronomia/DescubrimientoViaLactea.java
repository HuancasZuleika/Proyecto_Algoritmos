 ...
 * @author User
 */
public class DescubrimientoViaLactea extends javax.swing.JFrame {
    
    private AstronautaController astro;
    private AudioController audio;
    
    public DescubrimientoViaLactea() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DescubrimientoViaLactea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DescubrimientoViaLactea().setVisible(true);
