 ...
 * @author sayuri
 */
public class Quiz_Origen3 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Quiz_Origen3.class.getName());
...
// Agrega esto en el constructor Quiz_Origen()
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (respuestaCorrecta) {
            Quiz_Origen4 siguiente = new Quiz_Origen4();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Quiz_Origen3().setVisible(true));
    }
