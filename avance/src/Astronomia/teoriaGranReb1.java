 ...
 * @author User
 */
public class teoriaGranReb1 extends javax.swing.JFrame {
    
    private AstronautaController astro;
    private AudioController audio;
    
    public teoriaGranReb1() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teoriaGranReb1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new teoriaGranReb1().setVisible(true);
