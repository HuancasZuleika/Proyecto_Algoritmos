 ...
 * @author User
 */
public class teoriaUnivElec1 extends javax.swing.JFrame {
    
    private AstronautaController astro;
    private AudioController audio;
    
    public teoriaUnivElec1() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teoriaUnivElec1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new teoriaUnivElec1().setVisible(true);
