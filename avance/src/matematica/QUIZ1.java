...
public class QUIZ1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El Reto:¿Cuántos elemntos hay en total?");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 280, 810, 90));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/CONJUNTOB.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 540, 190, 170));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/Lapiz.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 430, 180, 130));

        jLabel7.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 153));
        jLabel7.setText("PREGUNTA:¿Cuántos elementos hay en total ");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 560, 460, 50));

        jLabel8.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 153));
        jLabel8.setText("en la unión de los conjuntos?");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 600, 420, 50));

        jLabel5.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 153));
        jLabel5.setText("Si unimos  las FRUTAS (A) y los JUGUETES (B)");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 370, 530, 70));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 300, 180, 40));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/LIBRO.Q1.png"))); // NOI18N
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 500, 90, 50));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/ESTRELLQAQ1-removebg-preview.png"))); // NOI18N
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 560, 80, 60));

        jLabel10.setFont(new java.awt.Font("Swis721 Blk BT", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText(" Y DIVIERTETE!");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 340, 210, 40));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/unnamed-removebg-preview (1).png"))); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 420, 90, 60));

        jLabel1.setBackground(new java.awt.Color(22, 7, 100));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/quiz1.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1620, 1000));
